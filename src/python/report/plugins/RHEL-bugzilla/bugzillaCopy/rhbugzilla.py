...
class RHBugzilla(base.BugzillaBase):
    ...
    version = '0.2'
    user_agent = base.user_agent + ' RHBugzilla/%s' % version

    def __init__(self,**kwargs):
        base.BugzillaBase.__init__(self,**kwargs)
    ...
    def _getbugs(self,idlist):
        ...
        return base.replace_getbug_errors_with_None(raw_results)
...
class RHBugzilla3(Bugzilla34, RHBugzilla):
    ...
    version = '0.1'
    user_agent = base.user_agent + ' RHBugzilla3/%s' % version
    ...
    def _getbugs(self,idlist):
        ...
        if self.multicall:
            ...
            del mc
            # check results for xmlrpc errors, and replace them with None
            r = base.replace_getbug_errors_with_None(raw_results)
        else:
